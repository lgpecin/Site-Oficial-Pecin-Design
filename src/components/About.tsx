  ...
  return <section id="about" className="py-12 sm:py-16 bg-secondary/30">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mt-16">
          <AnimatedSection>
            <p className="text-lg text-muted-foreground leading-relaxed">Eu me chamo Léo, sou de Maringá (PR), tenho 22 anos e já atuo na área há mais de seis anos. Desde que me entendo por gente, busco olho para as coisas com um viés artístico e peguei gosto em desenhar, rabiscar, escrever, criar... me encontrei no design e me apaixonei em dar vidas aos mais diversos projetos.</p>
          </AnimatedSection>
        </div>
      </div>
    </section>;
