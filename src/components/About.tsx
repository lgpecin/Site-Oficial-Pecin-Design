  ...
  return <section id="about" className="py-16 bg-secondary/30">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <AnimatedSection>
            <div className="relative aspect-square rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <img src={profilePhoto} alt="Léo - Designer" className="w-full h-full object-cover" />
            </div>
          </AnimatedSection>

          {/* Grid 2x2 de skills */}
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            {skills.map((skill, index) => <AnimatedSection key={skill.title}>
        ...
        <div className="max-w-3xl mx-auto text-center mt-16">
          <p className="text-lg text-muted-foreground leading-relaxed">Eu me chamo Léo, sou de Maringá (PR), tenho 22 anos e já atuo na área há mais de seis anos. Desde que me entendo por gente, busco olho para as coisas com um viés artístico e peguei gosto em desenhar, rabiscar, escrever, criar... me encontrei no design e me tornei apaixonado em dar vidas aos mais diferentes                                                                                                                                                                                                                                                                                        </p>
        </div>
      </div>
    </section>;
};
